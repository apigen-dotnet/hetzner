...
/// <summary>
/// CreateNetworkRequestRoutes from OpenAPI schema.
/// Schema path: #/components/schemas/CreateNetworkRequestRoutes
/// </summary>
public partial class CreateNetworkRequestRoutes
{
  /// <summary>
