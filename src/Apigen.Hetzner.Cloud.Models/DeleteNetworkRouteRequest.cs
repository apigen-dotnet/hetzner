...
/// <summary>
/// DeleteNetworkRouteRequest (generated from inline request body).
/// Source: POST /networks/{id}/actions/delete_route (requestBody)
/// </summary>
public partial class DeleteNetworkRouteRequest
{
  /// <summary>
