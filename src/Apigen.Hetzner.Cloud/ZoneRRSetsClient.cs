...
/// </summary>
public partial class ZoneRRSetsClient : IZoneRRSetsClient
{
  ...
  /// </summary>
  public async Task<JsonElement> GetZoneRrsetAsync(string idOrName, string rrName, string rrType, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id_or_name"] = idOrName,
  ...
  /// </summary>
  public async Task<JsonElement> UpdateZoneRrsetAsync(string idOrName, string rrName, string rrType, Apigen.Hetzner.Cloud.Models.UpdateZoneRrsetRequest updateZoneRrsetRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id_or_name"] = idOrName,
  ...
  /// </summary>
  public async Task<JsonElement> DeleteZoneRrsetAsync(string idOrName, string rrName, string rrType, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id_or_name"] = idOrName,
