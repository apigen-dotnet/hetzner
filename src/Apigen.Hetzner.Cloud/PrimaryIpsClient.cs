...
/// </summary>
public partial class PrimaryIpsClient
{
  private readonly HttpClient _httpClient;
  private readonly ILogger? _logger;

  internal PrimaryIpsClient(HttpClient httpClient, ILogger? logger = null)
  {
  ...
  /// </summary>
  public async Task<JsonElement> ListPrimaryIpsAsync(ListPrimaryIpsRequest? request = null, CancellationToken cancellationToken = default)
  {
    string url = "primary_ips".BuildUrl(request: request);
  ...
  /// </summary>
  public async Task<JsonElement> CreatePrimaryIpAsync(Apigen.Hetzner.Cloud.Models.CreatePrimaryIpRequest createPrimaryIpRequest, CancellationToken cancellationToken = default)
  {
    string url = "primary_ips";

    try
    {
      long startTimestamp = System.Diagnostics.Stopwatch.GetTimestamp();
      HttpClientLog.LogDebugRequestStarted(_logger, "POST", url);
      string json = JsonSerializer.Serialize(createPrimaryIpRequest, JsonConfig.Default);
  ...
  public async Task<JsonElement> GetAsync(int id, CancellationToken cancellationToken = default)
  {
    ...
    string url = "primary_ips/{id}".BuildUrl(pathParams);
  ...
  /// </summary>
  public async Task<JsonElement> UpdateAsync(int id, Apigen.Hetzner.Cloud.Models.UpdatePrimaryIpRequest updatePrimaryIpRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
    ...
    try
    {
      ...
      string json = JsonSerializer.Serialize(updatePrimaryIpRequest, JsonConfig.Default);
