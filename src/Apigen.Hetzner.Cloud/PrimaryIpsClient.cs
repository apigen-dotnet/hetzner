...
/// </summary>
public partial class PrimaryIpsClient : IPrimaryIpsClient
{
  ...
  /// </summary>
  public async Task<JsonElement> GetPrimaryIpAsync(long id, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<JsonElement> UpdatePrimaryIpAsync(long id, Apigen.Hetzner.Cloud.Models.UpdatePrimaryIpRequest updatePrimaryIpRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task DeletePrimaryIpAsync(long id, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
