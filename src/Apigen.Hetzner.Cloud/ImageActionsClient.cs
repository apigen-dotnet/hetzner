...
/// </summary>
public partial class ImageActionsClient
{
  private readonly HttpClient _httpClient;
  private readonly ILogger? _logger;

  internal ImageActionsClient(HttpClient httpClient, ILogger? logger = null)
  {
  ...
  /// </summary>
  public async Task<JsonElement> ListImagesActionsAsync(ListImagesActionsRequest? request = null, CancellationToken cancellationToken = default)
  {
    string url = "images/actions".BuildUrl(request: request);
  ...
  public async Task<JsonElement> GetAsync(int id, CancellationToken cancellationToken = default)
  {
    ...
    string url = "images/actions/{id}".BuildUrl(pathParams);
  ...
  /// </summary>
  public async Task<JsonElement> ListImageActionsAsync(int id, ListImageActionsRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
    };
    string url = "images/{id}/actions".BuildUrl(pathParams, request);
  ...
  /// </summary>
  public async Task<JsonElement> ChangeImageProtectionAsync(int id, Apigen.Hetzner.Cloud.Models.ChangeImageProtectionRequest changeImageProtectionRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
    };
    string url = "images/{id}/actions/change_protection".BuildUrl(pathParams);

    try
    {
      long startTimestamp = System.Diagnostics.Stopwatch.GetTimestamp();
      HttpClientLog.LogDebugRequestStarted(_logger, "POST", url);
      string json = JsonSerializer.Serialize(changeImageProtectionRequest, JsonConfig.Default);
  ...
  public async Task<JsonElement> GetAsync(int id, int actionId, CancellationToken cancellationToken = default)
  {
    ...
    string url = "images/{id}/actions/{action_id}".BuildUrl(pathParams);
