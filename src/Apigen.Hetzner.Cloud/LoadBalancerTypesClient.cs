...
/// </summary>
public partial class LoadBalancerTypesClient : ILoadBalancerTypesClient
{
  ...
  /// </summary>
  public async Task<JsonElement> ListAsync(ListLoadBalancerTypesRequest? request = null, CancellationToken cancellationToken = default)
  {
