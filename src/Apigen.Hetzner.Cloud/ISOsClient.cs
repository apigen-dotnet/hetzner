...
/// </summary>
public partial class ISOsClient
{
  private readonly HttpClient _httpClient;
  private readonly ILogger? _logger;

  internal ISOsClient(HttpClient httpClient, ILogger? logger = null)
  {
  ...
  /// Operation: GET /isos
  /// </summary>
  public async Task<JsonElement> ListIsosAsync(ListIsosRequest? request = null, CancellationToken cancellationToken = default)
  {
    string url = "isos".BuildUrl(request: request);
  ...
  public async Task<JsonElement> GetAsync(int id, CancellationToken cancellationToken = default)
  {
    ...
    string url = "isos/{id}".BuildUrl(pathParams);
