...
/// </summary>
public partial class ISOsClient : IISOsClient
{
  ...
  /// Operation: GET /isos
  /// </summary>
  public async Task<JsonElement> ListAsync(ListIsosRequest? request = null, CancellationToken cancellationToken = default)
  {
