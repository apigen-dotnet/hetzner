...
public partial class ImagesClient : IImagesClient
{
  ...
  /// </summary>
  public async Task<JsonElement> ListAsync(ListImagesRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<JsonElement> UpdateAsync(long id, Apigen.Hetzner.Cloud.Models.UpdateImageRequest updateImageRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
