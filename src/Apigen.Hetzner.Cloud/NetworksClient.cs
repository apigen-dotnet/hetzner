...
public partial class NetworksClient
{
  ...
  /// </summary>
  public async Task<JsonElement> ListNetworksAsync(ListNetworksRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<JsonElement> CreateAsync(Apigen.Hetzner.Cloud.Models.CreateNetworkRequest createNetworkRequest, CancellationToken cancellationToken = default)
  {
    string url = "networks";
  ...
  /// </summary>
  public async Task<JsonElement> UpdateAsync(int id, Apigen.Hetzner.Cloud.Models.UpdateNetworkRequest updateNetworkRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
