...
public partial class CertificatesClient : ICertificatesClient
{
  ...
  /// </summary>
  public async Task<JsonElement> ListAsync(ListCertificatesRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<JsonElement> UpdateAsync(long id, Apigen.Hetzner.Cloud.Models.UpdateCertificateRequest updateCertificateRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
