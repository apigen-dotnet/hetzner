...
/// </summary>
public partial class ServerTypesClient
{
  private readonly HttpClient _httpClient;
  private readonly ILogger? _logger;

  internal ServerTypesClient(HttpClient httpClient, ILogger? logger = null)
  {
  ...
  /// </summary>
  public async Task<JsonElement> ListServerTypesAsync(ListServerTypesRequest? request = null, CancellationToken cancellationToken = default)
  {
    string url = "server_types".BuildUrl(request: request);
  ...
  public async Task<JsonElement> GetAsync(int id, CancellationToken cancellationToken = default)
  {
    ...
    string url = "server_types/{id}".BuildUrl(pathParams);
