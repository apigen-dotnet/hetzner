...
/// </summary>
public partial class ServerTypesClient : IServerTypesClient
{
  ...
  /// </summary>
  public async Task<JsonElement> ListAsync(ListServerTypesRequest? request = null, CancellationToken cancellationToken = default)
  {
