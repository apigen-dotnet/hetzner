...
/// </summary>
public partial class FloatingIpsClient : IFloatingIpsClient
{
  ...
  /// </summary>
  public async Task<JsonElement> GetFloatingIpAsync(long id, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<JsonElement> UpdateFloatingIpAsync(long id, Apigen.Hetzner.Cloud.Models.UpdateFloatingIpRequest updateFloatingIpRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task DeleteFloatingIpAsync(long id, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
