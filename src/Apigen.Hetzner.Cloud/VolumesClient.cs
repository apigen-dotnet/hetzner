...
public partial class VolumesClient : IVolumesClient
{
  ...
  /// </summary>
  public async Task<JsonElement> ListAsync(ListVolumesRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<JsonElement> UpdateAsync(long id, Apigen.Hetzner.Cloud.Models.UpdateVolumeRequest updateVolumeRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
