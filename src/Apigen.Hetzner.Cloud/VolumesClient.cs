...
public partial class VolumesClient
{
  ...
  /// </summary>
  public async Task<JsonElement> ListVolumesAsync(ListVolumesRequest? request = null, CancellationToken cancellationToken = default)
  {
    string url = "volumes".BuildUrl(request: request);
  ...
  /// </summary>
  public async Task<JsonElement> CreateAsync(Apigen.Hetzner.Cloud.Models.CreateVolumeRequest createVolumeRequest, CancellationToken cancellationToken = default)
  {
    string url = "volumes";
    ...
    try
    {
      ...
      string json = JsonSerializer.Serialize(createVolumeRequest, JsonConfig.Default);
  ...
  public async Task<JsonElement> GetAsync(int id, CancellationToken cancellationToken = default)
  {
    ...
    string url = "volumes/{id}".BuildUrl(pathParams);
  ...
  /// </summary>
  public async Task<JsonElement> UpdateAsync(int id, Apigen.Hetzner.Cloud.Models.UpdateVolumeRequest updateVolumeRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
