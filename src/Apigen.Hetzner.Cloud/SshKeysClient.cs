...
/// </summary>
public partial class SshKeysClient
{
  private readonly HttpClient _httpClient;
  private readonly ILogger? _logger;

  internal SshKeysClient(HttpClient httpClient, ILogger? logger = null)
  {
  ...
  /// </summary>
  public async Task<JsonElement> ListSshKeysAsync(ListSshKeysRequest? request = null, CancellationToken cancellationToken = default)
  {
    string url = "ssh_keys".BuildUrl(request: request);
  ...
  /// </summary>
  public async Task<JsonElement> CreateSshKeyAsync(Apigen.Hetzner.Cloud.Models.CreateSshKeyRequest createSshKeyRequest, CancellationToken cancellationToken = default)
  {
    string url = "ssh_keys";
    ...
    try
    {
      ...
      string json = JsonSerializer.Serialize(createSshKeyRequest, JsonConfig.Default);
  ...
  public async Task<JsonElement> GetAsync(int id, CancellationToken cancellationToken = default)
  {
    ...
    string url = "ssh_keys/{id}".BuildUrl(pathParams);
  ...
  /// </summary>
  public async Task<JsonElement> UpdateAsync(int id, Apigen.Hetzner.Cloud.Models.UpdateSshKeyRequest updateSshKeyRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
