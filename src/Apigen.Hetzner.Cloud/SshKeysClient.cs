...
/// </summary>
public partial class SshKeysClient : ISshKeysClient
{
  ...
  /// </summary>
  public async Task<JsonElement> ListAsync(ListSshKeysRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<JsonElement> CreateAsync(Apigen.Hetzner.Cloud.Models.CreateSshKeyRequest createSshKeyRequest, CancellationToken cancellationToken = default)
  {
    string url = "ssh_keys";
  ...
  /// </summary>
  public async Task<JsonElement> UpdateAsync(long id, Apigen.Hetzner.Cloud.Models.UpdateSshKeyRequest updateSshKeyRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
