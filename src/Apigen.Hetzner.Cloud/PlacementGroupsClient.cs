...
/// </summary>
public partial class PlacementGroupsClient : IPlacementGroupsClient
{
  ...
  /// </summary>
  public async Task<JsonElement> ListAsync(ListPlacementGroupsRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<JsonElement> CreateAsync(Apigen.Hetzner.Cloud.Models.CreatePlacementGroupRequest createPlacementGroupRequest, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<JsonElement> UpdateAsync(long id, Apigen.Hetzner.Cloud.Models.UpdatePlacementGroupRequest updatePlacementGroupRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
