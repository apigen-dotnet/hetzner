...
/// </summary>
public partial class PlacementGroupsClient
{
  private readonly HttpClient _httpClient;
  private readonly ILogger? _logger;

  internal PlacementGroupsClient(HttpClient httpClient, ILogger? logger = null)
  {
  ...
  /// </summary>
  public async Task<JsonElement> ListPlacementGroupsAsync(ListPlacementGroupsRequest? request = null, CancellationToken cancellationToken = default)
  {
    string url = "placement_groups".BuildUrl(request: request);
  ...
  /// </summary>
  public async Task<JsonElement> CreatePlacementGroupAsync(Apigen.Hetzner.Cloud.Models.CreatePlacementGroupRequest createPlacementGroupRequest, CancellationToken cancellationToken = default)
  {
    string url = "placement_groups";

    try
    {
      long startTimestamp = System.Diagnostics.Stopwatch.GetTimestamp();
      HttpClientLog.LogDebugRequestStarted(_logger, "POST", url);
      string json = JsonSerializer.Serialize(createPlacementGroupRequest, JsonConfig.Default);
  ...
  public async Task<JsonElement> GetAsync(int id, CancellationToken cancellationToken = default)
  {
    ...
    string url = "placement_groups/{id}".BuildUrl(pathParams);
  ...
  /// </summary>
  public async Task<JsonElement> UpdateAsync(int id, Apigen.Hetzner.Cloud.Models.UpdatePlacementGroupRequest updatePlacementGroupRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
    ...
    try
    {
      ...
      string json = JsonSerializer.Serialize(updatePlacementGroupRequest, JsonConfig.Default);
