...
/// </summary>
public partial class ZonesClient : IZonesClient
{
  ...
  /// Operation: GET /zones
  /// </summary>
  public async Task<JsonElement> ListAsync(ListZonesRequest? request = null, CancellationToken cancellationToken = default)
  {
