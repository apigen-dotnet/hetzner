...
/// </summary>
public partial class LoadBalancersClient : ILoadBalancersClient
{
  ...
  /// </summary>
  public async Task<JsonElement> ListAsync(ListLoadBalancersRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<JsonElement> CreateAsync(Apigen.Hetzner.Cloud.Models.CreateLoadBalancerRequest createLoadBalancerRequest, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<JsonElement> UpdateAsync(long id, Apigen.Hetzner.Cloud.Models.UpdateLoadBalancerRequest updateLoadBalancerRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<JsonElement> GetLoadBalancerMetricsAsync(long id, GetLoadBalancerMetricsRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
