...
/// </summary>
public partial class DataCentersClient : IDataCentersClient
{
  ...
  /// </summary>
  public async Task<JsonElement> GetDatacenterAsync(long id, CancellationToken cancellationToken = default)
  {
