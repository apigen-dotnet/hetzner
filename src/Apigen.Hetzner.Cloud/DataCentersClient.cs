...
/// </summary>
public partial class DataCentersClient
{
  private readonly HttpClient _httpClient;
  private readonly ILogger? _logger;

  internal DataCentersClient(HttpClient httpClient, ILogger? logger = null)
  {
  ...
  /// </summary>
  public async Task<JsonElement> ListDatacentersAsync(ListDatacentersRequest? request = null, CancellationToken cancellationToken = default)
  {
    string url = "datacenters".BuildUrl(request: request);
  ...
  public async Task<JsonElement> GetAsync(int id, CancellationToken cancellationToken = default)
  {
    ...
    string url = "datacenters/{id}".BuildUrl(pathParams);
