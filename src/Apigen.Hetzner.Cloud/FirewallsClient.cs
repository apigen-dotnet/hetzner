...
public partial class FirewallsClient
{
  ...
  internal FirewallsClient(HttpClient httpClient, ILogger? logger = null)
  {
  ...
  /// </summary>
  public async Task<JsonElement> ListFirewallsAsync(ListFirewallsRequest? request = null, CancellationToken cancellationToken = default)
  {
    string url = "firewalls".BuildUrl(request: request);
  ...
  /// </summary>
  public async Task<JsonElement> CreateAsync(Apigen.Hetzner.Cloud.Models.CreateFirewallRequest createFirewallRequest, CancellationToken cancellationToken = default)
  {
    string url = "firewalls";

    try
    {
      long startTimestamp = System.Diagnostics.Stopwatch.GetTimestamp();
      HttpClientLog.LogDebugRequestStarted(_logger, "POST", url);
      string json = JsonSerializer.Serialize(createFirewallRequest, JsonConfig.Default);
  ...
  public async Task<JsonElement> GetAsync(int id, CancellationToken cancellationToken = default)
  {
    ...
    string url = "firewalls/{id}".BuildUrl(pathParams);
  ...
  /// </summary>
  public async Task<JsonElement> UpdateAsync(int id, Apigen.Hetzner.Cloud.Models.UpdateFirewallRequest updateFirewallRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
    ...
    try
    {
      ...
      string json = JsonSerializer.Serialize(updateFirewallRequest, JsonConfig.Default);
