...
/// </summary>
public partial class FirewallsClient : IFirewallsClient
{
  ...
  /// </summary>
  public async Task<JsonElement> ListAsync(ListFirewallsRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<JsonElement> UpdateAsync(long id, Apigen.Hetzner.Cloud.Models.UpdateFirewallRequest updateFirewallRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
