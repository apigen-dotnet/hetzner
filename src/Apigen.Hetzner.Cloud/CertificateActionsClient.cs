...
public partial class CertificateActionsClient
{
  ...
  /// </summary>
  public async Task<JsonElement> ListCertificatesActionsAsync(ListCertificatesActionsRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<JsonElement> ListCertificateActionsAsync(int id, ListCertificateActionsRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<JsonElement> RetryCertificateAsync(int id, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
