...
/// </summary>
public partial class CertificateActionsClient : ICertificateActionsClient
{
  ...
  /// </summary>
  public async Task<JsonElement> ListAsync(ListCertificatesActionsRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<JsonElement> ListAsync(long id, ListCertificateActionsRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<JsonElement> RetryCertificateAsync(long id, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
