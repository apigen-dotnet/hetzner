...
public partial class ServersClient
{
  ...
  internal ServersClient(HttpClient httpClient, ILogger? logger = null)
  {
  ...
  /// </summary>
  public async Task<JsonElement> ListServersAsync(ListServersRequest? request = null, CancellationToken cancellationToken = default)
  {
    string url = "servers".BuildUrl(request: request);
  ...
  /// </summary>
  public async Task<JsonElement> CreateAsync(Apigen.Hetzner.Cloud.Models.CreateServerRequest createServerRequest, CancellationToken cancellationToken = default)
  {
    string url = "servers";
    ...
    try
    {
      ...
      string json = JsonSerializer.Serialize(createServerRequest, JsonConfig.Default);
  ...
  public async Task<JsonElement> GetAsync(int id, CancellationToken cancellationToken = default)
  {
    ...
    string url = "servers/{id}".BuildUrl(pathParams);
  ...
  /// </summary>
  public async Task<JsonElement> UpdateAsync(int id, Apigen.Hetzner.Cloud.Models.UpdateServerRequest updateServerRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
    ...
    try
    {
      ...
      string json = JsonSerializer.Serialize(updateServerRequest, JsonConfig.Default);
  ...
  /// </summary>
  public async Task<JsonElement> GetServerMetricsAsync(int id, GetServerMetricsRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
    };
    string url = "servers/{id}/metrics".BuildUrl(pathParams, request);
