...
public partial class StorageBoxSubaccountsClient
{
  ...
  /// </summary>
  public async Task<JsonElement> ListStorageBoxSubaccountsAsync(int id, ListStorageBoxSubaccountsRequest? request = null)
  {
  ...
  /// </summary>
  public async Task<JsonElement> CreateStorageBoxSubaccountAsync(int id, Apigen.Hetzner.Api.Models.CreateStorageBoxSubaccountRequest createStorageBoxSubaccountRequest)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<JsonElement> GetAsync(int id, int subaccountId)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id,
  ...
  /// </summary>
  public async Task<JsonElement> UpdateAsync(int id, int subaccountId, Apigen.Hetzner.Api.Models.UpdateStorageBoxSubaccountRequest updateStorageBoxSubaccountRequest)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id,
  ...
  /// </summary>
  public async Task<JsonElement> DeleteAsync(int id, int subaccountId)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id,
