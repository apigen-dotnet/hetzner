...
/// </summary>
public partial class StorageBoxSubaccountsClient : IStorageBoxSubaccountsClient
{
  ...
  /// </summary>
  public async Task<JsonElement> ListAsync(long id, ListStorageBoxSubaccountsRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<JsonElement> CreateAsync(long id, Apigen.Hetzner.Api.Models.CreateStorageBoxSubaccountRequest createStorageBoxSubaccountRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<JsonElement> GetAsync(long id, long subaccountId, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id,
  ...
  /// </summary>
  public async Task<JsonElement> UpdateAsync(long id, long subaccountId, Apigen.Hetzner.Api.Models.UpdateStorageBoxSubaccountRequest updateStorageBoxSubaccountRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id,
  ...
  /// </summary>
  public async Task<JsonElement> DeleteAsync(long id, long subaccountId, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id,
