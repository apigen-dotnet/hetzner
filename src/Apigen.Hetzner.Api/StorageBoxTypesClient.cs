...
/// </summary>
public partial class StorageBoxTypesClient : IStorageBoxTypesClient
{
  ...
  /// </summary>
  public async Task<JsonElement> ListAsync(ListStorageBoxTypesRequest? request = null, CancellationToken cancellationToken = default)
  {
