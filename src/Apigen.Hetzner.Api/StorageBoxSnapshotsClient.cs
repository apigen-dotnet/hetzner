...
/// </summary>
public partial class StorageBoxSnapshotsClient : IStorageBoxSnapshotsClient
{
  ...
  /// </summary>
  public async Task<JsonElement> ListAsync(long id, ListStorageBoxSnapshotsRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<JsonElement> CreateAsync(long id, Apigen.Hetzner.Api.Models.CreateStorageBoxSnapshotRequest createStorageBoxSnapshotRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<JsonElement> GetAsync(long id, long snapshotId, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id,
  ...
  /// </summary>
  public async Task<JsonElement> UpdateAsync(long id, long snapshotId, Apigen.Hetzner.Api.Models.UpdateStorageBoxSnapshotRequest updateStorageBoxSnapshotRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id,
  ...
  /// </summary>
  public async Task<JsonElement> DeleteAsync(long id, long snapshotId, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id,
