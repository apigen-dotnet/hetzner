...
/// </summary>
public partial class StorageBoxSubaccountActionsClient : IStorageBoxSubaccountActionsClient
{
  ...
  /// </summary>
  public async Task<JsonElement> ChangeStorageBoxSubaccountHomeDirectoryAsync(long id, long subaccountId, Apigen.Hetzner.Api.Models.ChangeStorageBoxSubaccountHomeDirectoryRequest changeStorageBoxSubaccountHomeDirectoryRequest, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<JsonElement> ResetStorageBoxSubaccountPasswordAsync(long id, long subaccountId, Apigen.Hetzner.Api.Models.ResetStorageBoxSubaccountPasswordRequest resetStorageBoxSubaccountPasswordRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id,
  ...
  /// </summary>
  public async Task<JsonElement> UpdateStorageBoxSubaccountAccessSettingsAsync(long id, long subaccountId, Apigen.Hetzner.Api.Models.UpdateStorageBoxSubaccountAccessSettingsRequest updateStorageBoxSubaccountAccessSettingsRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id,
