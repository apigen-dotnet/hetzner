...
/// </summary>
public partial class StorageBoxesClient
{
  private readonly HttpClient _httpClient;
  private readonly ILogger? _logger;

  internal StorageBoxesClient(HttpClient httpClient, ILogger? logger = null)
  {
  ...
  /// </summary>
  public async Task<JsonElement> ListStorageBoxesAsync(ListStorageBoxesRequest? request = null, CancellationToken cancellationToken = default)
  {
    string url = "storage_boxes".BuildUrl(request: request);
  ...
  /// </summary>
  public async Task<JsonElement> CreateStorageBoxAsync(Apigen.Hetzner.Api.Models.CreateStorageBoxRequest createStorageBoxRequest, CancellationToken cancellationToken = default)
  {
    string url = "storage_boxes";

    try
    {
      long startTimestamp = System.Diagnostics.Stopwatch.GetTimestamp();
      HttpClientLog.LogDebugRequestStarted(_logger, "POST", url);
      string json = JsonSerializer.Serialize(createStorageBoxRequest, JsonConfig.Default);
  ...
  public async Task<JsonElement> GetAsync(int id, CancellationToken cancellationToken = default)
  {
    ...
    string url = "storage_boxes/{id}".BuildUrl(pathParams);
  ...
  /// </summary>
  public async Task<JsonElement> UpdateAsync(int id, Apigen.Hetzner.Api.Models.UpdateStorageBoxRequest updateStorageBoxRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
    ...
    try
    {
      ...
      string json = JsonSerializer.Serialize(updateStorageBoxRequest, JsonConfig.Default);
  ...
  /// </summary>
  public async Task<JsonElement> DeleteAsync(int id, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<JsonElement> ListStorageBoxFoldersAsync(int id, ListStorageBoxFoldersRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
    };
    string url = "storage_boxes/{id}/folders".BuildUrl(pathParams, request);
