...
public partial class RdnsClient
{
  ...
  /// </summary>
  public async Task<RdnsGetResponse> GetAsync(string ip, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<RdnsCreateResponse> UpdateAsync(string ip, Apigen.Hetzner.Robot.Models.RdnsCreateRequest rdnsCreateRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["ip"] = ip
  ...
  /// </summary>
  public async Task<RdnsUpdateResponse> RdnsUpdateAsync(string ip, Apigen.Hetzner.Robot.Models.RdnsUpdateRequest rdnsUpdateRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["ip"] = ip
  ...
  /// </summary>
  public async Task DeleteAsync(string ip, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["ip"] = ip
