...
/// </summary>
public partial class RdnsClient : IRdnsClient
{
  ...
  /// </summary>
  public async Task<RdnsUpdateResponse> UpdateAsync(string ip, Apigen.Hetzner.Robot.Models.RdnsUpdateRequest rdnsUpdateRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["ip"] = ip
