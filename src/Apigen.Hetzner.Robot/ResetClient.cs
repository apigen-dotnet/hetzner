...
/// </summary>
public partial class ResetClient : IResetClient
{
  ...
  /// </summary>
  public async Task<ResetExecuteResponse> ExecuteAsync(string serverNumber, Apigen.Hetzner.Robot.Models.ResetExecuteRequest resetExecuteRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["server_number"] = serverNumber
