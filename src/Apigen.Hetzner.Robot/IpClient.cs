...
/// </summary>
public partial class IpClient : IIpClient
{
  ...
  /// </summary>
  public async Task<IpSetTrafficWarningLimitsResponse> SetTrafficWarningLimitsAsync(string ip, Apigen.Hetzner.Robot.Models.IpSetTrafficWarningLimitsRequest ipSetTrafficWarningLimitsRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["ip"] = ip
