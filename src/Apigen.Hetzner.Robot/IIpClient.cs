...
public partial interface IIpClient
{
  ...
  /// </summary>
  Task<IpSetTrafficWarningLimitsResponse> SetTrafficWarningLimitsAsync(string ip, Apigen.Hetzner.Robot.Models.IpSetTrafficWarningLimitsRequest ipSetTrafficWarningLimitsRequest, CancellationToken cancellationToken = default);
