...
/// </summary>
public partial class VswitchClient : IVswitchClient
{
  ...
  /// </summary>
  public async Task<JsonElement> ChangeVlanAsync(int vswitchId, Apigen.Hetzner.Robot.Models.VswitchChangeVlanRequest vswitchChangeVlanRequest, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<JsonElement> AddServersAsync(int vswitchId, Apigen.Hetzner.Robot.Models.VswitchAddServersRequest vswitchAddServersRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["vswitch_id"] = vswitchId
  ...
  /// </summary>
  public async Task RemoveServersAsync(int vswitchId, Apigen.Hetzner.Robot.Models.VswitchRemoveServersRequest vswitchRemoveServersRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["vswitch_id"] = vswitchId
