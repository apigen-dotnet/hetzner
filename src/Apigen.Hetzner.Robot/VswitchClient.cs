...
public partial class VswitchClient
{
  ...
  /// </summary>
  public async Task<VswitchCreateResponse> CreateAsync(CancellationToken cancellationToken = default)
  {
    string url = "vswitch";
  ...
  /// </summary>
  public async Task<JsonElement> VswitchChangeVlanAsync(int vswitchId, Apigen.Hetzner.Robot.Models.VswitchChangeVlanRequest vswitchChangeVlanRequest, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task DeleteAsync(int vswitchId, Apigen.Hetzner.Robot.Models.VswitchCancelRequest vswitchCancelRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["vswitch_id"] = vswitchId
  ...
  /// </summary>
  public async Task<JsonElement> VswitchAddServersAsync(int vswitchId, Apigen.Hetzner.Robot.Models.VswitchAddServersRequest vswitchAddServersRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["vswitch_id"] = vswitchId
  ...
  /// </summary>
  public async Task VswitchRemoveServersAsync(int vswitchId, Apigen.Hetzner.Robot.Models.VswitchRemoveServersRequest vswitchRemoveServersRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["vswitch_id"] = vswitchId
