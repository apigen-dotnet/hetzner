...
/// </summary>
public partial class FirewallClient : IFirewallClient
{
  ...
  /// </summary>
  public async Task<JsonElement> CreateOrUpdateFromTemplateAsync(string serverNumber, string port, Apigen.Hetzner.Robot.Models.FirewallCreateOrUpdateFromTemplateRequest firewallCreateOrUpdateFromTemplateRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["server_number"] = serverNumber,
  ...
  /// </summary>
  public async Task<List<FirewallTemplateGetAllResponse>> TemplateGetAllAsync(CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<FirewallTemplateCreateResponse> TemplateCreateAsync(Apigen.Hetzner.Robot.Models.FirewallTemplateCreateRequest firewallTemplateCreateRequest, CancellationToken cancellationToken = default)
  {
    string url = "firewall/template";
  ...
  /// </summary>
  public async Task<FirewallTemplateGetResponse> TemplateGetAsync(string templateId, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
  ...
  /// </summary>
  public async Task<FirewallTemplateUpdateNameResponse> TemplateUpdateNameAsync(int templateId, Apigen.Hetzner.Robot.Models.FirewallTemplateUpdateNameRequest firewallTemplateUpdateNameRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["template_id"] = templateId
  ...
  /// </summary>
  public async Task TemplateDeleteAsync(int templateId, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["template_id"] = templateId
