...
public partial class SubnetClient
{
  ...
  /// </summary>
  public async Task<List<SubnetGetByServerIpResponse>> ListAsync(SubnetGetByServerIpRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<SubnetGetResponse> GetAsync(string ip, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<SubnetSetTrafficWarningLimitsResponse> SubnetSetTrafficWarningLimitsAsync(string ip, Apigen.Hetzner.Robot.Models.SubnetSetTrafficWarningLimitsRequest subnetSetTrafficWarningLimitsRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["ip"] = ip
  ...
  /// </summary>
  public async Task<SubnetMacGetResponse> SubnetMacGetAsync(string ip, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["ip"] = ip
  ...
  /// </summary>
  public async Task<SubnetMacSetResponse> SubnetMacSetAsync(string ip, Apigen.Hetzner.Robot.Models.SubnetMacSetRequest subnetMacSetRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["ip"] = ip
  ...
  /// </summary>
  public async Task<SubnetMacResetResponse> SubnetMacResetAsync(string ip, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["ip"] = ip
