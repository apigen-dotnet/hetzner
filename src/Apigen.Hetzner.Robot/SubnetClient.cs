...
/// </summary>
public partial class SubnetClient : ISubnetClient
{
  ...
  /// </summary>
  public async Task<SubnetSetTrafficWarningLimitsResponse> SetTrafficWarningLimitsAsync(string ip, Apigen.Hetzner.Robot.Models.SubnetSetTrafficWarningLimitsRequest subnetSetTrafficWarningLimitsRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["ip"] = ip
  ...
  /// </summary>
  public async Task<SubnetMacGetResponse> MacGetAsync(string ip, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["ip"] = ip
  ...
  /// </summary>
  public async Task<SubnetMacSetResponse> MacSetAsync(string ip, Apigen.Hetzner.Robot.Models.SubnetMacSetRequest subnetMacSetRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["ip"] = ip
  ...
  /// </summary>
  public async Task<SubnetMacResetResponse> MacResetAsync(string ip, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["ip"] = ip
