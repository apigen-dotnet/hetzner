...
/// </summary>
public partial class FailoverClient : IFailoverClient
{
  ...
  /// </summary>
  public async Task<FailoverRouteResponse> RouteAsync(string ip, Apigen.Hetzner.Robot.Models.FailoverRouteRequest failoverRouteRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["ip"] = ip
