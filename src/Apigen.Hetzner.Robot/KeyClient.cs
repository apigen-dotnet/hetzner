...
public partial class KeyClient
{
  ...
  /// Operation: GET /key
  /// </summary>
  public async Task<List<KeyGetAllResponse>> ListAsync(KeyGetAllRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// Operation: POST /key
  /// </summary>
  public async Task<KeyCreateResponse> CreateAsync(Apigen.Hetzner.Robot.Models.KeyCreateRequest keyCreateRequest, CancellationToken cancellationToken = default)
  {
    string url = "key";
  ...
  /// </summary>
  public async Task<KeyGetResponse> GetAsync(string fingerprint, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<KeyUpdateResponse> KeyUpdateAsync(string fingerprint, Apigen.Hetzner.Robot.Models.KeyUpdateRequest keyUpdateRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["fingerprint"] = fingerprint
  ...
  /// </summary>
  public async Task DeleteAsync(string fingerprint, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["fingerprint"] = fingerprint
