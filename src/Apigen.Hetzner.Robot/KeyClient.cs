...
public partial class KeyClient : IKeyClient
{
  ...
  /// </summary>
  public async Task<KeyUpdateResponse> UpdateAsync(string fingerprint, Apigen.Hetzner.Robot.Models.KeyUpdateRequest keyUpdateRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["fingerprint"] = fingerprint
