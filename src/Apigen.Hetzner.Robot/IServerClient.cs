...
public partial interface IServerClient
{
  ...
  /// </summary>
  Task<ServerCancellationGetResponse> CancellationGetAsync(string serverNumber, CancellationToken cancellationToken = default);

  /// <summary>
  /// Cancel a server
  /// Operation: POST /server/{server_number}/cancellation
  /// </summary>
  Task<ServerCancelResponse> CancelAsync(string serverNumber, CancellationToken cancellationToken = default);

  /// <summary>
  /// Revoke a server cancellation
  /// Operation: DELETE /server/{server_number}/cancellation
  /// </summary>
  Task CancellationDeleteAsync(string serverNumber, CancellationToken cancellationToken = default);
